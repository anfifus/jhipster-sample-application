...
class RatingResourceIT {
    ...
    private static final Integer DEFAULT_PUNTUATION = 1;
    private static final Integer UPDATED_PUNTUATION = 2;
    ...
    public static Rating createEntity(EntityManager em) {
        Rating rating = new Rating().puntuation(DEFAULT_PUNTUATION).date(DEFAULT_DATE);
        return rating;
    }
    ...
    public static Rating createUpdatedEntity(EntityManager em) {
        Rating rating = new Rating().puntuation(UPDATED_PUNTUATION).date(UPDATED_DATE);
        return rating;
    }
    ...
    void createRating() throws Exception {
        ...
        assertThat(testRating.getPuntuation()).isEqualTo(DEFAULT_PUNTUATION);
    ...
    void getAllRatings() throws Exception {
        ...
        restRatingMockMvc
            ...
            .andExpect(jsonPath("$.[*].puntuation").value(hasItem(DEFAULT_PUNTUATION)))
    ...
    void getRating() throws Exception {
        ...
        restRatingMockMvc
            ...
            .andExpect(jsonPath("$.puntuation").value(DEFAULT_PUNTUATION))
    ...
    void putNewRating() throws Exception {
        ...
        updatedRating.puntuation(UPDATED_PUNTUATION).date(UPDATED_DATE);
        ...
        Rating testRating = ratingList.get(ratingList.size() - 1);
        assertThat(testRating.getPuntuation()).isEqualTo(UPDATED_PUNTUATION);
    ...
    void partialUpdateRatingWithPatch() throws Exception {
        ...
        partialUpdatedRating.puntuation(UPDATED_PUNTUATION).date(UPDATED_DATE);
