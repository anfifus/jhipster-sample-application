...
import RatingUpdateComponent from '@/entities/rating/rating-update.vue';
import RatingClass from '@/entities/rating/rating-update.component';
...
describe('Component Tests', () => {
  describe('Rating Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<RatingClass>(RatingUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
        provide: {
          ...
          videoService: () =>
            sinon.createStubInstance<VideoService>(VideoService, {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.rating = entity;
        ratingServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(ratingServiceStub.update.calledWith(entity)).toBeTruthy();
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        ratingServiceStub.retrieve.resolves([foundRating]);
