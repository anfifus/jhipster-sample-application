      ...
      <table class="table table-striped" aria-describedby="ratings">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.rating.user')">User</span></th>
            <th scope="row"><span v-text="$t('jhipsterSampleApplicationApp.rating.video')">Video</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
