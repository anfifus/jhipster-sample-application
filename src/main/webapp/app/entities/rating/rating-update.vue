    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.rating.user')" for="rating-user">User</label>
            <select class="form-control" id="rating-user" data-cy="user" name="user" v-model="rating.user">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="rating.user && userOption.id === rating.user.id ? rating.user : userOption"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.rating.video')" for="rating-video">Video</label>
            <select class="form-control" id="rating-video" data-cy="video" name="video" v-model="rating.video">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="rating.video && videoOption.id === rating.video.id ? rating.video : videoOption"
